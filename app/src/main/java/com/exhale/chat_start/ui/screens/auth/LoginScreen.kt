...
fun LoginScreen(navController: NavController, authViewModel: AuthViewModel) {
    ...
    Column(
        ...
        Text("Login", style = MaterialTheme.typography.h4, color = MaterialTheme.colors.primary)
        ...
        Button(
            onClick = {
                if (authViewModel.login(nameInput, passInput)) {
        ...
        TextButton(onClick = { navController.navigate(ScreenRoutes.Register.route) }) {
